        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:26px">
          ...
          <div>
            ...
            <ul style="margin:0;padding-left:18px;line-height:1.85">
              ...
              <li><b>Real nonfiction, woven in</b> — each growth story pairs with a true account of a real person who failed first, building the informational-text reading kids are tested on most</li>
...
route('parent', async () => {
  ...
  // COPPA email-plus: resend the verification link (wired to the dashboard banner button).
  ...
  $('#nk-go').onclick = async () => {
    if (me.parent && !me.parent.email_verified) { showError('#nk-err', 'Please confirm your email first — click the link we sent to ' + me.parent.email + '. That verifies parental consent before we create your child\'s profile.'); return; }
...
route('standards', async () => {
  ...
  app().innerHTML = topbar(`<div class="container" style="max-width:880px">
    ...
    <div class="card" style="margin-top:16px;text-align:center">
      <p class="muted" style="margin:0 0 12px">Questions about alignment to your state's standards? Email <a href="mailto:support@learnwithgallop.com" style="color:var(--brand)">support@learnwithgallop.com</a> — nearly every state builds its standards on these same national frameworks, so the coverage map above applies in your state too.</p>
