        ...
        <div class="subject-report">
          ...
          ${s.placed ? `
            ...
            <div class="advance-box">
              ...
              <p class="advance-counts" style="margin-top:8px"><span class="muted" style="display:block;font-size:.82rem;margin-bottom:4px">Across every skill ${esc(k.name)} has practiced so far <i>(any grade — this can include review skills below ${esc(s.levelName)}, which is why it may differ from the ${esc(s.levelName)} count above)</i>:</span><span class="pill strength">💪 ${s.progress.mastered} mastered</span> <span class="pill inprog">📈 ${s.progress.inProgress} in progress</span> <span class="pill focus">🎯 ${s.progress.toStrengthen} to strengthen</span> <span class="muted" style="font-size:.82rem">· ${s.progress.totalCorrect}/${s.progress.totalAnswered} of those correct</span></p>
            </div>` : ''}
