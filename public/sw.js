...
const CACHE = 'gallop-v211';
const STATIC = ['/', '/index.html', '/styles.css', '/app.js', '/games.js', '/curriculum.js', '/careers.js', '/finance.js', '/growth.js', '/lessons.js', '/lessons_patch.js', '/lessons_ext.js', '/manifest.json', '/icon-192.png', '/icon-512.png', '/logo-mark.png', '/logo-roundel.png', '/logo-full.png', '/logo-full-dark.png', '/favicon-32.png', '/apple-touch-icon.png'];
